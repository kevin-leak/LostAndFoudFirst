package com.example.lostandfoudfirst.adapter;
...
import com.example.lostandfoudfirst.bean.Goods;
import com.example.lostandfoudfirst.holder.CommonViewHolder;
...
public class MembersAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder>{
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        return new CommonViewHolder(parent.getContext(), parent, layout, type) {
            @Override
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        if (goodsList.size() > 0){
            ((CommonViewHolder) holder).bindData(goodsList.get(position));
        }else {
            ((CommonViewHolder) holder).bindData(null);
        }
    }
